...
//to update the votes
export const updateVotes = async (request: Request, h: ResponseToolkit) => {
  try {
...
//to add a comment
export const addComment = async (request: Request, h: ResponseToolkit) => {
  try {
    const { user_id } = request.auth.credentials;
...
export const getComments = async (request: Request, h: ResponseToolkit) => {
  try {
